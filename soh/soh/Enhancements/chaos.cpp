...
static std::map<uint8_t, CommandCreator> kCommands {
	...
	CMD_ONE_SHOT(0x04, PL_NONE(), { scale(&(GET_PLAYER(gGlobalCtx)->actor), 1.5f, 1.5f, 1.5f); }),
	CMD_ONE_SHOT(0x05, PL_NONE(), { scale(&(GET_PLAYER(gGlobalCtx)->actor), 0.66f, 0.66f, 0.66f); }),
