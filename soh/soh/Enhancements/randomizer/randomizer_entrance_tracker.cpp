...
void DrawEntranceTracker(bool& open) {
    ...
    size_t hash = boost::hash_value_32(thing);
    ...
    ImGui::Text("boost::hash_value(\"12345\") == %" SSIZET_FMT, boost::hash_value_32(thing));
    ImGui::Text("boost::hash_value(seed with settingsStr) == %" SSIZET_FMT, boost::hash_value_32(thing + thing2));
