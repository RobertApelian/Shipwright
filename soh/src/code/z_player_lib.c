...
u8 gPlayerModelTypes[PLAYER_MODELGROUP_MAX][PLAYER_MODELGROUPENTRY_MAX] = {
    /* PLAYER_MODELGROUP_0 */
    {
        PLAYER_ANIMTYPE_HOLDING_SHIELD,
    ...
    {
        PLAYER_ANIMTYPE_HOLDING_ONE_HAND_WEAPON,
    ...
    {
        PLAYER_ANIMTYPE_HOLDING_TWO_HAND_WEAPON,
    ...
    {
        PLAYER_ANIMTYPE_HOLDING_ITEM_IN_LEFT_HAND,
    ...
    {
        PLAYER_ANIMTYPE_USED_EXPLOSIVE,
        PLAYER_MODELTYPE_LH_OPEN,
        PLAYER_MODELTYPE_RH_OPEN,
        PLAYER_MODELTYPE_SHEATH_18,
        PLAYER_MODELTYPE_WAIST
...
s32 Player_IsBurningStickInRange(PlayState* play, Vec3f* pos, f32 xzRange, f32 yRange) {
    ...
    if ((this->heldItemAction == PLAYER_IA_DEKU_STICK) && (this->fpsItemType != 0)) {
...
void Player_PostLimbDrawGameplay(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    if (CVarGetInteger("gLetItSnow", 0) && !(this->stateFlags1 & PLAYER_STATE1_IN_FIRST_PERSON_MODE) && !(this->stateFlags2 & PLAYER_STATE2_INSIDE_CRAWLSPACE)) {
        if (limbIndex == PLAYER_LIMB_HEAD) {
            OPEN_DISPS(play->state.gfxCtx);
