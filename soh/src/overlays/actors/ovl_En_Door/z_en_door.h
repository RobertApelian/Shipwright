...
typedef struct EnDoor {
    ...
    /* 0x0190 */ u8 animStyle; // Must be at same offset as animStyle in DoorKiller due to the cast in Player_SetupOpenDoor
    /* 0x0191 */ u8 playerIsOpening; // Must be at same offset as playerIsOpening in DoorKiller due to the cast in Player_SetupOpenDoor
    /* 0x0192 */ u8 unk_192;
